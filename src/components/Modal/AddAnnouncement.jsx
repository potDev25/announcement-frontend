...
import { storeAnnouncement } from "../../redux/slice/announcementSlice";

export default function AddAnnouncement({ open, handleModal }) {
  ...
  const handleSubmit = () => {
    dispatch(storeAnnouncement(payload));
  };
    ...
    <>
      <dialog className={`modal ${open ? "modal-open" : ""}`}>
        <div className="modal-box w-11/12 max-w-2xl">
          <h3 className="font-bold text-sm uppercase">Create Announcement</h3>
